...
export default {
  ...
  MetaAthletePrimitivesAthlete: {
    ...
    athleteKind: 'Bytes',
    athleteSports: 'Bytes',
    athleteBirthdate: 'Bytes',
    athleteBirthplace: 'Bytes',
  ...
  /**
   * Lookup6: meta_athlete_primitives::Kind
   **/
  MetaAthletePrimitivesKind: {
    kind: 'u32'
  },
  /**
   * Lookup6: meta_athlete_primitives::Sports
   **/
  MetaAthletePrimitivesSports: {
    sports: 'u32'
  },
  /**
   * Lookup6: meta_athlete_primitives::Birthdate
   **/
  MetaAthletePrimitivesBirthdate: {
    date: 'Bytes'
    // year: 'u32',
    // month: 'u32',
    // day: 'u32'
  ...
  /**
   * Lookup6: meta_athlete_primitives::Birthplace
   **/
  MetaAthletePrimitivesBirthplace: {
    athleteBirthplace: 'Bytes'
  },
  /**
  ...
  PalletAthletesCall: {
    _enum: {
      ...
      mint_cards: {
        athleteId: 'u64',
        cardInfo: 'MetaAthletePrimitivesAthleteApplication',   
      },
      buy_card: {
        cardHash: 'H256',
      },
