...
declare module '@polkadot/types/lookup' {
  ...
  export interface MetaAthletePrimitivesAthlete extends Struct {
    ...
    readonly athleteKind: Bytes;
    readonly athleteSports: Bytes;
    readonly athleteBirthdate: Bytes;
    readonly athleteBirthplace: Bytes;
  ...
  /** @name MetaAthletePrimitivesKind (6) */
  export interface MetaAthletePrimitivesKind extends Struct {
    readonly kind: u32;
  }

  /** @name MetaAthletePrimitivesSports (6) */
  export interface MetaAthletePrimitivesSports extends Struct {
    readonly sports: u32;
  }

  /** @name MetaAthletePrimitivesBirthdate (6) */
  export interface MetaAthletePrimitivesBirthdate extends Struct {
    readonly date: Bytes;
    // readonly year: u32;
    // readonly month: u32;
    // readonly day: u32;
  ...
  /** @name MetaAthletePrimitivesBirthplace (6) */
  export interface MetaAthletePrimitivesBirthplace extends Struct {
    readonly athleteBirthplace: Bytes;
  }
  ...
  export interface MetaAthletePrimitivesCard extends Struct {
    ...
    readonly cardInfo: MetaAthletePrimitivesAthleteApplication;
