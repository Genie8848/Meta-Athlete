...
import type { FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, MetaAthletePrimitivesAthleteApplication, MetaAthletePrimitivesAthleteCardClass, MetaAthletePrimitivesCardId, SpFinalityGrandpaAppPublic, SpRuntimeDispatchError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    athletes: {
      ...
      CardMinted: AugmentedEvent<ApiType, [H256, MetaAthletePrimitivesCardId, MetaAthletePrimitivesAthleteApplication,  MetaAthletePrimitivesAthleteCardClass]>;
      // CardMinted: AugmentedEvent<ApiType, [H256, MetaAthletePrimitivesAthleteApplication, MetaAthletePrimitivesAthleteApplication,  MetaAthletePrimitivesAthleteCardClass]>;
