...
pub const VERSION: RuntimeVersion = RuntimeVersion {
  ...
  authoring_version: 1,
  impl_name: create_runtime_str!("meta-athlete"),
  impl_version: 1,
  spec_name: create_runtime_str!("meta-athlete"),
  spec_version: 100,
  state_version: 1,
...
parameter_types! {
  ...
  pub InitialCardValues: meta_athlete_primitives::InitialCardValues<Balance> = meta_athlete_primitives::InitialCardValues {
...
impl frame_system::offchain::AppCrypto<MultiSigner, MultiSignature> for OffchainAppCrypto {
  ...
  type RuntimeAppPublic = pallet_athletes::Public;
}
