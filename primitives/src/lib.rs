...
impl<T> From<AthleteApplication<T>> for Athlete<T> {
  fn from(other: AthleteApplication<T>) -> Self {
    Athlete {
      ...
      athleteKind: other.athleteKind,
      athleteSports: other.athleteSports,
      athleteBirthdate: other.athleteBirthdate,
      athleteBirthplace: other.athleteBirthplace,
      weight: other.weight,
      height: other.height,
      photo: other.photo,
      cards_minted: false,
